...
import com.example.bootagain.service.ArticleService;
...
public class ArticleApiController {
    ...
    public ResponseEntity<Article> create(@RequestBody ArticleForm adto) {
        Article created = articleService.create(adto);
        return (created != null) ?
